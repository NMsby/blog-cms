        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <select id="category_ids" name="category_ids[]" multiple class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <select id="tag_ids" name="tag_ids[]" multiple class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        @foreach($tags as $tag)
            ...
            <div class="mb-4">
                ...
                @if($post->featured_image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $post->featured_image) }}" alt="Featured Image" class="w-32 h-32 object-cover">
                    </div>
                @endif
